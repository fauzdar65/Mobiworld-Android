...
public class CartList extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    if(od.size()>0)
	    {
	    	...
	    	ld.setOnItemClickListener(new OnItemClickListener(){
	    	 ...
	    	 ListAdapter adapter = new SimpleAdapter( CartList.this,od, R.layout.single_order_row, new String[] { "Model","PID"}, new int[] {R.id.model,R.id.pid});
	...
	class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(CartList.this);
